...
> 🛡️ **Hardening Réseau** : En entreprise, on désactive le DHCP sur les segments serveurs. Cela empêche l'attribution automatique d'IP à des équipements non autorisés et garantit la stabilité des futurs services DNS.
...
Le paramétrage DNS est l'étape la plus critique. Pour un premier DC, on pointe sur soi-même.
  ...
  <div class="overflow-hidden rounded-lg border border-white/10">
    <table class="w-full text-sm text-left">
      ...
      <tbody>
        ...
        <tr>
          <td class="p-3 border-b border-white/10 font-bold">DNS Secondaire</td>
          <td class="p-3 border-b border-white/10 text-green-400">127.0.0.1 (Loopback)</td>
        </tr>
      </tbody>
    </table>
  </div>
   <div style="display: flex; flex-direction: column; align-items: center; max-width: 400px;">
    <img src="/images/projets/win-infra-core/roles/ipstatique.png" alt="nommer le serveur" style="width: 100%; height: auto; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1);" />
    <p style="font-size: 0.65rem; text-align: center; opacity: 0.5; margin-top: 8px; font-style: italic;">Identification de la VM dans l'inventaire</p>
  </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <div class="flex flex-col items-center">
    <img src="/images/projets/win-infra-core/roles/serveur-adds.png" alt="Sélection AD DS" class="rounded-lg border border-white/10 w-full" />
    <p class="text-[0.65rem] italic opacity-50 mt-2">Sélection du rôle AD DS</p>
  </div>
  <div class="flex flex-col items-center">
    <img src="/images/projets/win-infra-core/roles/ad-install.png" alt="Installation AD DS" class="rounded-lg border border-white/10 w-full" />
    <p class="text-[0.65rem] italic opacity-50 mt-2">Confirmation et installation des binaires</p>
  </div>
</div>
...
<NextStep 
  ...
  description="Comment transformer ce serveur en une nouvelle forêt Active Directory." 
