...
<div class="flex flex-col items-center my-10">
  <div class="max-w-2xl w-full">
    <img src="/images/projets/win-infra-core/roles/ajouter-role.png" alt="Menu Gérer" class="rounded-xl border border-white/10 shadow-2xl" />
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
  <div class="space-y-4">
    ...
    <figure>
      <img src="/images/projets/win-infra-core/roles/ad-install.png" alt="Sélection AD DS" class="rounded-lg border border-white/10 w-full shadow-md" />
